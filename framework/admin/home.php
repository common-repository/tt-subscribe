...
function tt_subscribe_html_page() {
	 ...
	 if ( get_option('tt-subscribe-height') == '' ) $height='currently <span class="empty">empty</span> and default'; else $height=get_option('tt-subscribe-height');
