    ...
    <div class="tt-subscribe-admin">
		...
		<div class="tt-subscribe-admin-content" id="ts-4">
            ...
            <div class="tt-subscribe-admin-section tt-subscribe-admin-support">
            	...
            	<p><strong>Height</strong> is where you enter the number in pixels of the height you want for your widget. Please do not include the pixel code, for it will not be read by the widget. If you wish to add this to your theme, the custom option is `tt-subscribe-height`.</p>
